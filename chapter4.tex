...
This chapter describes the technical architecture and technology stack used in the development, deployment, and maintenance of InferX-ML. The platform follows a modern microservices-based architecture integrating a React-based frontend, a Flask-powered backend, and a modular machine learning engine. It leverages PostgreSQL for relational data storage and MinIO for scalable object storage. The entire system is containerized using Docker and orchestrated via Docker Compose, ensuring reproducibility and ease of deployment.
